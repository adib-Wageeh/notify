...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is NotificationAction&&(identical(other.id, id) || other.id == id)&&(identical(other.title, title) || other.title == title));
}
...
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? title = null,}) {
  return _then(NotificationAction(
